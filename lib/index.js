  ...
  route.before(function (options) {
    ...
    var next = function () {
      ...
      animationQueue.enqueue(function () { return animateBetweenPages({
        ...
        nextElement          :   options.metadata && options.metadata.direction === 'back' && openPages.length ? openPages.pop() : generateNextElement.apply(null, args),
        ...
        order                :   options.metadata && options.metadata.direction === 'back' && openPages.length ? 'reshowThenRemove' : 'addThenRemove' //if going back and the previous page is still in the DOM, then reshowThenRemove, otherwise, addThenRemove
      }) }.bind(this))
    }.bind(this)
