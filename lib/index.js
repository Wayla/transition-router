...
function Router(options) {
  ...
  //fix for Chrome 34 no longer firing popstate on initial load: http://stackoverflow.com/questions/22957298/google-chrome-has-popstate-trigggering-on-initial-page-load-changed-in-v34
...
//getViewless just executes a route handler, it doesnt transiton elements in or out

Router.prototype.getViewless = function(path, routeHandler){
  //no support for middleware ATM


  var route = new Route(path)
  this.routes.push(route)
  route.before(routeHandler)
